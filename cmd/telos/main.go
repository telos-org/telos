...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "  plan SPEC.md       Preview changes; --out=FILE saves a Change Request")
	fmt.Fprintln(out, "  apply SPEC|PLAN    Confirm a new spec or a saved Change Request")
